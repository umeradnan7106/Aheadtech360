      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
          <div className="flex size-full flex-col items-start justify-start text-start">
            ...
            <a className="mb-2 flex justify-start text-start" href="#">
              <h2 className="text-xl font-bold md:text-2xl">
                How we scaled a Shopify store to six figures
              </h2>
            </a>
            <p>
              From zero to consistent monthly revenue through paid ads and site
              optimization
            </p>
            <Button
              title="Read more"
          ...
          <div className="flex size-full flex-col items-start justify-start text-start">
            ...
            <a className="mb-2 flex justify-start text-start" href="#">
              <h2 className="text-xl font-bold md:text-2xl">
                SEO strategy that filled their calendar
              </h2>
            </a>
            <p>
              A plumbing company went from sporadic leads to booked appointments
              every week
            </p>
            <Button
              title="Read more"
          ...
          <div className="flex size-full flex-col items-start justify-start text-start">
            ...
            <a className="mb-2 flex justify-start text-start" href="#">
              <h2 className="text-xl font-bold md:text-2xl">
                How email marketing doubled their membership
              </h2>
            </a>
            <p>
              A gym used automated campaigns to convert past leads into active
              members
            </p>
            <Button
              title="Read more"
