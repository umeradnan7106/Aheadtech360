      ...
      <div className="container">
        <div className="grid auto-cols-fr grid-cols-1 items-center gap-12 md:gap-16 lg:grid-cols-2 lg:gap-20">
          <div className="w-full max-w-md lg:mb-24">
            ...
            <p className="md:text-md">From brands we've scaled</p>
          </div>
          <Carousel
            ...
            <CarouselContent>
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "We went from $2,000 a month in revenue to $18,000 in just
                    four months. Generic Growth Partners knew exactly where to
                    spend our budget."
                  </blockquote>
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Our ROAS jumped from 2.1 to 4.8 in the first quarter. They
                    didn't just run ads—they understood our customers."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                      <img
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "We were losing money on every campaign until Generic Growth
                    Partners stepped in. Now we're profitable and scaling."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                      <img
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "The team didn't just deliver ads. They delivered a strategy
                    that made sense for our gym's seasonal needs."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                      <img
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Within six weeks, we had more qualified leads than we could
                    handle. Their targeting is surgical."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                      <img
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "They turned our worst-performing channel into our best. The
                    difference was in the strategy, not the spend."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                      <img
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Generic Growth Partners doesn't just manage campaigns. They
                    manage growth. That's the difference."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                      <img
